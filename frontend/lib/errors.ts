...
const MENSAJES: Record<string, string> = {
  ...
  CUENTA_DUPLICADA: "Ya existe una cuenta con ese código en la empresa.",
  TERCERO_DUPLICADO: "Ya existe un tercero con ese tipo y número de documento.",
  TERCERO_DV_INVALIDO: "El dígito de verificación no corresponde al número de documento.",
